...
import { createBudget } from '@/app/api/budget/create/route'
import { getBudgets } from '@/app/api/budget/route'
import { deleteCategory } from '@/app/api/category/[id]/delete/route'
import { updateCategory } from '@/app/api/category/[id]/update/route'
import { createCategory } from '@/app/api/category/create/route'
import { getCategories } from '@/app/api/category/route'
import { deleteTransaction } from '@/app/api/transaction/[id]/delete/route'
import { updateTransaction } from '@/app/api/transaction/[id]/update/route'
import { createTransaction } from '@/app/api/transaction/create/route'
import { getTransactions } from '@/app/api/transaction/route'
import { deleteWallet } from '@/app/api/wallet/[id]/delete/route'
import { updateWallet } from '@/app/api/wallet/[id]/update/route'
import { createWallet } from '@/app/api/wallet/create/route'
import { getWallets } from '@/app/api/wallet/route'
import { transfer } from '@/app/api/wallet/transfer/route'
